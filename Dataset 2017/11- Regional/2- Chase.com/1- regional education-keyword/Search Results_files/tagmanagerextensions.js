CHASE.TagManager.xpoActivity = function(OrgID, AppID, TagMap, productId, sourceCode) {
    ...
    if (CHASE.TagManager.clientVars.env == 'prod')
        EnvID = 'rf15';
    var pixelUrl = "https://" + EnvID + ".chase.com/meta?_o={xpo.OrgID}";
...
CHASE.TagManager.audienceSyndication = function() {
	...
	xpoAudiences = function() {	
		...
		if (CHASE.TagManager.clientVars.env == 'prod')
			EnvID = 'rf15';
		segServiceURL = "https://"+ EnvID +".chase.com/wsb/15629/poe/59242226?_u=[ECI]&Debug=false&Test=false&ContentType=application/json&TransactionID=eee-444";
