...
//tealium universal tag - utag.sender.8009 ut4.0.201610250808, Copyright 2016 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
  ...
  u.extend=[];
    ...
    u.loader_cb = function (a, b) {
      ...
      utag.DB("send:40:CALLBACK:COMPLETE");
    };
    // End Loader Callback
