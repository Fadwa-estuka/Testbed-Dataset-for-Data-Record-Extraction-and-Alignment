...
bd_nd_statuses["NetDefender.HTTP.HUI"]["NetDefender.Feature.HTTP.HUI.IsActive"] = 0;
...
var bd_nd_E893A5F3FE87409FB167F51A030D021C_strings = 
{
	...
	toolbar_title : "Total Protection Plan",
...
function bd_nd_E893A5F3FE87409FB167F51A030D021C_ajax(callback)
{
	...
	this.sendRequest = function(params)
	{
		...
		this.ajax.setRequestHeader("BDNDSS_B67EA559F21B487F861FDA8A44F01C50", "10000000a75f3e1058a0e54b58a0c1efa75f3e10d2a768988fad38d53e6d998331c4b5096496a492");
...
var bd_nd_E893A5F3FE87409FB167F51A030D021C_tfHUI = new function () {
    ...
    this.PopulateSettings = function (settingsPage) {
        ...
        for (var i = 1; i < count; i++) {
            ...
            paragraph.innerHTML = "<div class='labelstatustxt'><div class='switch_label'>" + feature.title + "</div><div class='switch_line'> </div><div class='switch_description'>" + feature.description + '</div></div>';
