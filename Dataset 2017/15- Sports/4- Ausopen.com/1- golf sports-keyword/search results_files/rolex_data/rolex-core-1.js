...
// imagetype SVG
svg: {
hour: {width: 4}, minute: {width: 4}, second: {width: 3, xrotation: 1.5}
},
// imagetype PNG
png: {
hour: {width: 4}, minute: {width: 4}, second: {width: 3, xrotation: 1.5}
...
forceFlash: false,
forceFallback: false,
clocktimeAtEvent: true, //Tells whether we display the time at the event location, defined in listofdates.js or not (not tested yet)
