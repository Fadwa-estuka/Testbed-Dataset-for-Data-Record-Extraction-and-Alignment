...
this.Parent(g,d);
this.theme=d.theme||$_GLOBALS.getLRORValue("connect_button_theme")||"flat";
...
break
}var b=new IN.Objects.Button({title:a,size:this.size,theme:this.theme});
b.place(this.el());
...
if(!(IN&&IN.ENV&&IN.ENV.widget&&IN.ENV.widget.disable_widget_apply)){IN.addTag("Apply",IN.Tags.Apply)
};
