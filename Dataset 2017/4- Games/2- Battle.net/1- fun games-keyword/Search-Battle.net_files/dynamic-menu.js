 ...
 *
 * Initialize using DynamicMenu.factory();
 */
var DynamicMenu = {
	...
	/**
	 * Factory method for generating DynamicMenu instances.
	 *
	 * @param menu
	 * @param config
	 */
	factory: function(menu, config) {
		var instance = Object.create(DynamicMenu);
			instance.init(menu, config);
