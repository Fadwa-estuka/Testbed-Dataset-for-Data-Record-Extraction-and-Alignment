...
(function(g) {
  g.address = function() {
    var h = function(a) {
      ...
      return H.pushState && y.state !== s
    }, b = function() {
      return("/" + C.pathname.replace(RegExp(y.state), "") + C.search + (f() ? "#!" + f() : "")).replace(Q, "/")
    }, f = function() {
      var a = C.href.indexOf("#!");
      return a != -1 ? C.href.substr(a + 2) : ""
    }, i = function() {
      return e() ? b() : f()
    }, l = function() {
      try {
      ...
      a = a.toString();
      return(y.strict && a.substr(0, 1) != "/" ? "/" : "") + a
    }, k = function(a, b) {
      return parseInt(a.css(b), 10)
    }, n = function() {
      if(/^#/.test(C.hash) && !/^#!/.test(C.hash)) {
        C.hash = C.hash.replace("#", "#!")
      }
      if(!O) {
        var a = i();
        decodeURI(I) != decodeURI(a) && (L && J < 7 ? C.reload() : (L && !P && y.history && N(q, 50), I = a, m(A)))
      }
    }, m = function(a) {
      N(p, 10);
      return h(v).isDefaultPrevented() || h(a ? o : x).isDefaultPrevented()
    }, p = function() {
      if(y.tracker !== "null" && y.tracker !== w) {
        var a = g.isFunction(y.tracker) ? y.tracker : D[y.tracker], b = (C.pathname + C.search + (g.address && !e() ? g.address.value() : "")).replace(/\/\//, "/").replace(/^\/$/, "");
        g.isFunction(a) ? a(b) : g.isFunction(D.urchinTracker) ? D.urchinTracker(b) : D.pageTracker !== s && g.isFunction(D.pageTracker._trackPageview) ? D.pageTracker._trackPageview(b) : D._gaq !== s && g.isFunction(D._gaq.push) && D._gaq.push(["_trackPageview", decodeURI(b)])
      }
    }, q = function() {
      var a = "javascript:" + A + ";document.open();document.writeln('<html><head><title>" + E.title.replace(/\'/g, "\\'") + "</title><script>var " + z + ' = "' + encodeURIComponent(i()).replace(/\'/g, "\\'") + (E.domain != C.hostname ? '";document.domain="' + E.domain : "") + "\";<\/script></head></html>');document.close();";
      J < 7 ? K.src = a : K.contentWindow.location.replace(a)
    }, r = function() {
      if(F && U != -1) {
        var a, b, c = F.substr(U + 1).split("&");
        for(a = 0;a < c.length;a++) {
          b = c[a].split("="), /^(autoUpdate|history|strict|wrap)$/.test(b[0]) && (y[b[0]] = isNaN(b[1]) ? /^(true|yes)$/i.test(b[1]) : parseInt(b[1], 10) !== 0), /^(state|tracker)$/.test(b[0]) && (y[b[0]] = b[1])
        }
        F = w
      }
      I = i()
      ...
      if(!T) {
        ...
        if(y.wrap) {
          var a = g("body");
          g("body > *").wrapAll('<div style="padding:' + (k(a, "marginTop") + k(a, "paddingTop")) + "px " + (k(a, "marginRight") + k(a, "paddingRight")) + "px " + (k(a, "marginBottom") + k(a, "paddingBottom")) + "px " + (k(a, "marginLeft") + k(a, "paddingLeft")) + 'px;" />').parent().wrap('<div id="' + z + '" style="height:100%;overflow:auto;position:relative;' + (M && !window.statusbar.visible ? "resize:both;" : "") + '" />');
          g("html, body").css({height:"100%", margin:0, padding:0, overflow:"hidden"});
          M && g('<style type="text/css" />').appendTo("head").text("#" + z + "::-webkit-resizer { background-color: #fff; }")
        }
        if(L && !P) {
          a = E.getElementsByTagName("frameset")[0], K = E.createElement((a ? "" : "i") + "frame"), K.src = "javascript:" + A, a ? (a.insertAdjacentElement("beforeEnd", K), a[a.cols ? "cols" : "rows"] += ",0", K.noResize = B, K.frameBorder = K.frameSpacing = 0) : (K.style.display = "none", K.style.width = K.style.height = 0, K.tabIndex = -1, E.body.insertAdjacentElement("afterBegin", K)), N(function() {
            g(K).bind("load", function() {
        ...
        e() || (L && J > 7 || !L && P ? D.addEventListener ? D.addEventListener(u, n, A) : D.attachEvent && D.attachEvent("on" + u, n) : R(n, 50));
        "state" in window.history && g(window).trigger("popstate")
      }
    }, s, w = null, z = "jQueryAddress", u = "hashchange", v = "change", o = "internalChange", x = "externalChange", B = !0, A = !1, y = {autoUpdate:B, history:B, strict:B, frames:B, wrap:A}, G = function() {
      var a = {}, b;
      ...
      return a
    }(), J = parseFloat(G.version), M = G.webkit || G.safari, L = !g.support.opacity, D = l(), E = D.document, H = D.history, C = D.location, R = setInterval, N = setTimeout, Q = /\/{2,9}/g, G = navigator.userAgent, P = "on" + u in D, K, F = g("script:last").attr("src"), U = F ? F.indexOf("?") : -1, S = E.title, O = A, T = A, V = B, W = A, I = i();
    if(C.hash && /^#/.test(C.hash) && !/^#!/.test(C.hash)) {
      C.hash = C.hash.replace("#", "#!")
    }
    if(L) {
      J = parseFloat(G.substr(G.indexOf("MSIE") + 4));
      E.documentMode && E.documentMode != J && (J = E.documentMode != 8 ? 7 : 8);
      var X = E.onpropertychange;
      E.onpropertychange = function() {
        X && X.call(E);
        if(E.title != S && E.title.indexOf("#!" + i()) != -1) {
          E.title = S
        }
      }
    }
    if(H.navigationMode) {
      H.navigationMode = "compatible"
    }
    ...
    g(window).bind("popstate", function() {
      decodeURI(I) != decodeURI(i()) && (I = i(), m(A))
    }).bind("unload", function() {
      D.removeEventListener ? D.removeEventListener(u, n, A) : D.detachEvent && D.detachEvent("on" + u, n)
    });
    return{bind:function() {
      ...
      if(a !== s) {
        return y.autoUpdate = a, this
      }
      return y.autoUpdate
    }, history:function(a) {
      if(a !== s) {
        return y.history = a, this
      }
      return y.history
    }, state:function(a) {
      if(a !== s) {
        y.state = a;
        var c = b();
        y.state !== s && (H.pushState ? c.substr(0, 4) == "/#!/" && C.replace(y.state.replace(/^\/$/, "") + c.substr(2)) : c != "/" && c.replace(/^\/#!/, "") != f() && N(function() {
          C.replace(y.state.replace(/^\/$/, "") + "/#!" + c)
        }, 1));
        return this
      }
      return y.state
      ...
      if(a !== s) {
        return y.frames = a, D = l(), this
      }
      return y.frames
    }, strict:function(a) {
      if(a !== s) {
        return y.strict = a, this
      }
      return y.strict
    }, tracker:function(a) {
      if(a !== s) {
        return y.tracker = a, this
      }
      return y.tracker
    }, wrap:function(a) {
      if(a !== s) {
        return y.wrap = a, this
      }
      return y.wrap
    }, update:function() {
      W = B;
      ...
      if(a !== s) {
        return N(function() {
          S = E.title = a;
          if(V && K && K.contentWindow && K.contentWindow.document) {
            K.contentWindow.document.title = a, V = A
          }
        }, 50), this
      }
      return E.title
      ...
      if(a !== s) {
        ...
        if(y.autoUpdate || W) {
          ...
          if(e()) {
            H[y.history ? "pushState" : "replaceState"]({}, "", y.state.replace(/\/$/, "") + (I === "" ? "/" : I))
          }else {
            O = B;
            if(M) {
              y.history ? C.hash = "#!" + I : C.replace("#!" + I)
            }else {
              if(I != i()) {
                y.history ? C.hash = "#!" + I : C.replace("#!" + I)
              }
            }
            L && !P && y.history && N(q, 50);
            M ? N(function() {
              O = A
            }, 1) : O = A
          }
      ...
      if(a !== s) {
        return this.value(I.split("#!")[0] + (a ? "#!" + a : "")), this
      }
      a = I.split("#!");
...
(function(g, h) {
  ...
  function i(a, e, f, i, m) {
    var v, o = g.extend({}, g.fn.cycle.defaults, i || {}, g.metadata ? a.metadata() : g.meta ? a.data() : {}), x = g.isFunction(a.data) ? a.data(o.metaAttr) : null;
    x && (o = g.extend(o, x));
    if(o.autostop) {
    ...
    if((o.containerResize || o.containerResizeHeight) && a.innerHeight() < 1) {
      for(var y = x = v = 0;y < f.length;y++) {
        var G = g(f[y]), J = G[0], M = G.outerWidth(), L = G.outerHeight();
        M || (M = J.offsetWidth || J.width || G.attr("width"));
        L || (L = J.offsetHeight || J.height || G.attr("height"));
        v = M > v ? M : v;
        x = L > x ? L : x
      }
      o.containerResize && v > 0 && x > 0 && a.css({width:v + "px", height:x + "px"});
      o.containerResizeHeight && x > 0 && a.css({height:x + "px"})
    }
    var D = !1;
  ...
  g.fn.cycle.custom = function(a, b, c, d, e, f) {
    var i = g(a), h = g(b), l = c.speedIn, a = c.speedOut, j = c.easeIn, b = c.easeOut, m = c.animInDelay, e = c.animOutDelay;
    h.css(c.cssBefore);
    f && (l = typeof f == "number" ? a = f : a = 1, j = b = null);
    var k = function() {
      h.delay(m).animate(c.animIn, l, j, function() {
        d()
      })
    };
...
UnityObj = function() {
  ...
  return{k_protocolVersion:"1.0", k_serviceName:"json-rmc", k_typGetStubInfo:"GETSTUBINFO", k_typInvoke:"INVOKE", k_typOnEvent:"ONEVENT", k_typGlobalEvent:"GLOBALEVENT", k_connectionTimout:5E3, k_errNoDirectUnityObject:"no-unity-object", k_remoteAddress:"localhost", k_remotePort:8789, m_requestID:1, m_isRemote:window.unityAsync === void 0, m_wsConnection:null, m_requestCallbacks:{}, m_eventCallbacks:{}, m_waitingEvents:{}, m_requestHistory:[], callProxyMgr:function(d, c) {
    ...
    var c = null, e = this, b, f, i = null, l, j, k;
    try {
      c = JSON.parse(a)
    }catch(n) {
      h("Couldn't parse the reply from the unity engine", n)
    }
    if(c && c.type === this.k_typGlobalEvent) {
      console.log("Global event received: " + c.event), this.cancelEvents()
    }else {
      if(f = this.m_requestCallbacks[c.messageID], f !== void 0 ? delete this.m_requestCallbacks[c.messageID] : f = this.m_eventCallbacks[c.messageID], c.status < 0) {
        console.error("processResult error: " + a), f && f(c, null)
      }else {
        if(c.type === this.k_typGetStubInfo) {
          k = {}, k.events = c.result.events, $.each(c.result.properties, function(a, b) {
            k[b.name] = b.value
            ...
            k[d.name] = function() {
              ...
              l = 0;
              for(j = arguments.length - (a ? 1 : 0);l < j;l++) {
                b.params.push(arguments[l])
              }
              e.callProxyMgr(b, a)
            }
          }), k.on = function(a, b) {
        ...
        try {
          ...
          h("An error occured in the callback for the request", this.makeReplyData(m, c))
        }
      }
    }
  }}
...
Kharma.GA = function() {
  var g = "", h = "CN:N3", a = "CT:T1", d = "", c = "", e = [], b = !1, f = {}, i = document.location.href.match(/https?:\/\/\w+-(\w+)/) ? !1 : !0, l = !1, j = !1, k = !/KharmaBot/.test(window.navigator.userAgent), n = {payload:null, location:null}, m, p, q, r, t, s, w, z, u, v, o, x, B;
  m = function() {
    var a = $("#mainContent");
...
Kharma.Login = function(g) {
  var h = !1, a = !1, d = !1, c = "", e = !1, b, f, i, l, j, k, n, m, p, q, r, t, s, w, z, u, v, o, x, B, A, y, G = !/(AdlesseBot|AhrefsBot|archive\.org_bot|bingbot|BLEXBot|BoxcarBot|coccocbot|DeuSu|Discordbot|DotBot|DuckDuckGo|EveryoneSocialBot|Exabot|Feedspotbot|Googlebot|KharmaBot|Kraken|linkdexbot|LinkisBot|MixrankBot|MJ12bot|MojeekBot|OrangeBot|PaperLiBot|redditbot|SearchmetricsBot|SemrushBot|SeznamBot|SMTBot|spbot|SurdotlyBot|Uptimebot|Veoozbot|Yandex|Yeti)/i.test(window.navigator.userAgent);
  f = function(a) {
    var b = $("body");
  ...
  t = function() {
    Kharma.login.user.nps !== null && new Kharma.NpsDialog({closeCallback:function() {
    }, userNps:Kharma.login.user.nps, language:Kharma.login.user.language_code})
  };
  s = function() {
    Kharma.history.getCurrentPage().type === "hom" && Kharma.login.user.show_intro && G && Kharma.login.user.language_code === "en-US" && !Kharma.unityEditor.isUnity4x() && ($("body").addClass("intro"), $("body").append(Handlebars.templates.welcomeDialog({welcomeL10N:Kharma.l10n.welcome})), $(".intro-overlay a.get-started").on("click", function() {
  ...
  return{authenticate:function(a, b, c) {
    ...
    a && (a.clear(), a.load())
  }, updateToolbar:y, getUuid:function() {
    return c
  }, getType:function() {
...
Kharma.UnityEditor = function(g) {
  ...
  e = function() {
    return Kharma.utils.windowWrapper.navigator.userAgent.match(/Chrome\//) && Kharma.utils.windowWrapper.navigator.userAgent.match(/Chrome\//).length > 0
  };
  b = function() {
...
Kharma.Screensaver = function() {
  ...
  var h = [], a = {}, d = 0, c = null, e = null, b = null, f = 0, i = 0, l = 1, j = null, k = null, n = null, m, p, q, r, t, s, w, z, u, v, o = g(["transform", "-webkit-transform", "-moz-transform", "-ms-transform", "-o-transform"]), x = g(["transition", "-webkit-transition", "-moz-transition", "-ms-transition", "-o-transition"]);
  s = function(a, b, c) {
  ...
  w = function() {
    c ? (e.css("opacity", "0"), b.css("opacity", "0"), j = setTimeout(function() {
      e.remove();
      e = $('<div style="position:absolute;top:0px;width:100%;' + x + ":" + o + ' 12000s linear, opacity 2s linear;">');
      c.append(e);
      f++;
      i = 0;
      f === h.length && (f = 0);
    ...
    }, 2E3)) : (c = $('<div style="position:fixed;top:0px;right:0px;bottom:0px;left:0px;background-color:#000;z-index:20;' + x + ':opacity 2s linear">'), e = $('<div style="position:absolute;z-index:0;top:0px;width:100%;' + x + ":" + o + ' 12000s linear, opacity 2s linear;">'), b = $('<div style="position:fixed;z-index:1;bottom:50px;left:50px;font:normal 30px Arial,Helvetica,sans-serif;color:#444;opacity:0;' + x + ':opacity 1s linear;">'), c.append(e), c.append(b), $("body").append(c), c.on("click", 
    function() {
      v()
  ...
  q = function() {
    ...
    if(a.type !== "screenshot") {
      ...
      b.onload = function() {
        if(e) {
          var a = $(this), b = $('<div style="position:absolute;left:' + c + "px;top:" + window.innerHeight + "px;background-color:#fff;border:10px solid #fff;" + x + ":" + o + ' 1s ease-out;"/>');
          a.css("opacity", "0");
          a.css(x, "opacity 1s linear");
          b.append(a);
          e.append(b);
          var g;
...
Kharma.Page = function(g) {
  var h, a = [], d = g || {}, c = d.id || "0", e = "", b = !1, f = [], i = [], l = "", j, k = d.sortby, n, m, p, q, r, t, s, w, z, u, v, o, x, B, A, y, G, J, M;
  m = function(a) {
  ...
  o = function() {
    ...
    v(h);
    x(a ? "/api/category/top/paid/" + h + "/10.json" : "/api/home/top/paid/10.json", "paid", $("#topBox .top-paid"));
    x(a ? "/api/category/top/free/" + h + "/10.json" : "/api/home/top/free/10.json", "free", $("#topBox .top-free"));
    x(a ? "/api/category/top/grossing/" + h + "/10.json" : "/api/home/top/grossing/10.json", "grossing", $("#topBox .top-grossing"));
    x(a ? "/api/category/top/latest/" + h + "/10.json" : "/api/home/top/latest/10.json", "latest", $("#topBox .top-latest"));
  ...
  }, loadTopList:x, miniLink:function(a, b) {
...
Kharma.PurchaseDialog = function(g) {
  ...
  m = function() {
    var e = Kharma.ga.paymentInfo(), f = c.find(".select-box").val(), g;
    if(d) {
      if(f === "genesis") {
        e.processor = "Genesis"
      }else {
...
Kharma.ContentPage = function(g) {
  var h = null, a, d, c, e, b, f, i, l, j = g || {}, k, n = "", m, p, q, r, t, s, w, z, u, v, o, x, B, A, y, G, J, M, L, D, E, H, C, R, N, Q, P, K, F, U, S, O, T, V, W, I;
  q = function(a) {
  ...
  M = function() {
    Kharma.io.get({uri:"/api/content/overview/" + h.id + ".json", pageSpecific:!0, onSuccess:function(a) {
      var b, c = a.json;
      c.error === "not found" ? $.address.value("/404") : c.error === "disabled" ? (b = Kharma.l10n.supplant(Kharma.l10n.pkg.disabled, {name:c.content.title}), D(a, b)) : Kharma.download.getLocalPackageById("content", h.id, function(d) {
  ...
  Q = function(a) {
    ...
    b.length > 0 && S(a);
    V(a);
    a.flags && !a.flags.no_content && ($("#packageContents").removeClass("hidden"), H(), new Kharma.UI.AssetHierarchy(d, a));
    Kharma.login && Kharma.login.isAdmin && $("#adminlayer").is(":visible") && C();
    h.activateLinks();
    z(a);
  ...
  w = function(a) {
    ...
    new Kharma.TextMessage({title:Kharma.l10n.review.deleteReview, message:Kharma.l10n.review.deleteReviewMessage, withCancel:!0, options:{accept:Kharma.l10n.button.deleteButton, size:"small"}, callback:function(b) {
      b && x(a.target.getAttribute("data-id"))
    }})
  };
  x = function(a) {
  ...
  J = function(a) {
    a || (j.action === "review" ? F() : Kharma.io.get({uri:"/api/content/comments/" + h.id + "/3.json", pageSpecific:!0, onSuccess:function(a) {
      N(a.json, "show")
    }}))
  };
  N = function(a, b) {
  ...
  U = function(a) {
    a.json.content.flags && !a.json.content.flags.no_review && ($("#contentcomments").removeClass("hidden"), J(void 0))
  };
  O = function() {
  ...
  }, makeEditable:H, openAdminMode:C, renderComments:N, setLoaded:h.setLoaded, setRequestUrl:h.setRequestUrl, getRequestUrl:h.getRequestUrl, setTemplate:h.setTemplate, showLicense:O, showReleaseNotes:T, startReview:W, onResize:function() {
...
Kharma.ListPage = function(g) {
  ...
  n = function(a) {
    ...
    b = a.id;
    h.setPageTitle(g);
    d !== "" && (e.css("background-image", "url(" + d + ")"), e.show());
    d = $("<h1/>").text(g);
    e.after(d);
...
Kharma.SearchPage = function(g) {
  var h = null, a = null, d, c = g || {}, e = c.page, b, f = c.sortby, i = c.search, l, j, k, n, m, p, q, r, t, s, w, z, u, v, o, x, B, A, y, G, J, M, L, D, E, H, C, R, N, Q, P, K, F, U, S, O, T, V;
  l = function(a) {
    a = a && a.replace(/["']/g, "");
    $("#featured").show();
    Kharma.history.getCurrentPage().type === "sea" && x(a);
  ...
  j = function() {
    ...
    $("#searchOptions .free").off("click").on("click", function() {
      ...
      b.hasClass("inset") ? (b.removeClass("inset"), F(a, "price:0"), F(a, "free"), $(".price-slider").slider("value", 2E3)) : ($("#searchOptions .paid").removeClass("inset"), b.addClass("inset"), a.push("price:0"));
      H(a)
    });
    ...
    $("#searchOptions .packages").off("click").on("click", function() {
      var a = i.slice(), b = $(this);
      $(".price-slider").find(".value-indicator").remove();
      b.hasClass("inset") ? (b.removeClass("inset"), F(a, "type:content")) : ($("#searchOptions .paid").removeClass("inset"), b.addClass("inset"), a.push("type:content"));
      H(a)
    });
    $("#searchOptions .lists").off("click").on("click", function() {
      var a = i.slice(), b = $(this);
      $(".price-slider").find(".value-indicator").remove();
      b.hasClass("inset") ? (b.removeClass("inset"), F(a, "type:list")) : ($("#searchOptions .paid").removeClass("inset"), b.addClass("inset"), a.push("type:list"));
      H(a)
    })
  };
  n = function(a) {
    ...
    $("#categoryTree a").off("click").on("click", function(a) {
      ...
      if(Kharma.history.getCurrentPage().type === "sea") {
        if(a.preventDefault(), a.stopPropagation(), c === "Home") {
          $("#mainContent").off(Kharma.utils.events.onCategoryTreeLoaded), x(), $.address.value("/home")
        }else {
          a = 0;
  ...
  k = function() {
    $(".price-slider").slider({orientation:"horizontal", range:"min", min:0, max:2E3, value:2E3, slide:function(a, b) {
      ...
      e = z(g);
      g === 2E3 ? (d.hasClass("inset") ? f.push("price:>0") : F(f, "price:"), $(".price-slider").find(".value-indicator").remove(), c.removeClass("inset")) : d.hasClass("inset") && e > 0 ? (c.removeClass("inset"), f.push("price:>0-" + e)) : (e > 0 && c.removeClass("inset"), d.removeClass("inset"), f.push(e === 0 ? "price:0" : "price:0-" + e));
      H(f)
    }}).each(function() {
  ...
  m = function(a) {
    $("." + a + "-slider").slider({orientation:"horizontal", range:"min", min:0, max:1825, value:1825, slide:function(b, c) {
      ...
      d = w(f);
      f === 1825 ? (F(e, a + ":"), $("." + a + "-slider").find(".value-indicator").remove()) : e.push(a + ":" + d);
      H(e)
    }}).each(function() {
  ...
  q = function() {
    $(".size-slider").slider({orientation:"horizontal", range:"min", min:0, max:4E3, value:4E3, slide:function(a, b) {
      ...
      c = u(e);
      e === 4E3 ? (F(d, "size:"), $(".size-slider").find(".value-indicator").remove()) : d.push("size:0-" + c);
      H(d)
    }}).each(function() {
  ...
  G = function() {
    ...
    for(b = i.length;a < b;a++) {
      c = decodeURIComponent(i[a]).toLowerCase(), A(c), B(c), L(c), M(c), J(c), y(c, "released"), y(c, "updated")
    }
  };
  J = function(a) {
    var b, c;
  ...
  U = function(a) {
    ...
    if(e.indexOf("price:") !== -1) {
      F(i, "price:"), $("#searchOptions .free").removeClass("inset"), $("#searchOptions .paid").removeClass("inset"), a = $(".price-slider"), a.find(".value-indicator").remove(), a.slider("value", 2E3)
    }else {
      if(e.indexOf("size:") !== -1) {
        F(i, "size:"), $(".size-slider").slider("value", 4E3)
      }else {
        if(e.indexOf("released:") !== -1) {
          F(i, "released:"), $(".released-slider").slider("value", 1825)
        }else {
          if(e.indexOf("updated:") !== -1) {
            F(i, "updated:"), $(".updated-slider").slider("value", 1825)
          }else {
            if(e.indexOf("rating:") !== -1) {
              ...
              e.indexOf("version:") !== -1 ? (F(i, "version:"), $(".supported-version").val("")) : e.indexOf("only:") !== -1 ? (F(i, "type:"), $("#searchOptions .lists").removeClass("inset"), $("#searchOptions .packages").removeClass("inset")) : (e.indexOf("category:") !== -1 && (f = e.substr(e.indexOf(":") + 1), a = isNaN(parseInt(f, 10)) ? Kharma.helper.categories[f] : f, e = "category:" + (a || f), b = i.indexOf(e), b > -1 && i.splice(b, 1), e = "category:" + Kharma.helper.categories[a]), e.indexOf("publisher:") !== 
  ...
  V = function(a, b) {
    ...
    isNaN(d.substr(d.indexOf(":") + 1)) ? D(d) : E(d);
  ...
  a = new Kharma.List;
  return{id:h.id, type:h.type, clear:h.clear, changeSearchInputWidth:h.changeSearchInputWidth, getUrl:H, isLoaded:h.isLoaded, load:function() {
    var a = $("#mainContent"), b;
    if(!h.load()) {
    ...
    a.slider("value") !== 2E3 && (F(i, "price:"), a.slider("value", 2E3));
    ...
    f.val() !== "" && (F(i, "version:"), f.val(""));
    b.slider("value") !== 4E3 && (F(i, "size:"), b.slider("value", 4E3));
    d.slider("value") !== 1825 && (F(i, "released:"), d.slider("value", 1825));
    e.slider("value") !== 1825 && (F(i, "updated:"), e.slider("value", 1825));
...
Kharma.DownloadsPage = function(g) {
  var h = null, a = [], d, c = $(".download-manager"), e = !1, b = g || {}, f = [], i = [], l, j, k, n, m, p, q, r, t, s, w, z, u, v, o, x, B, A, y, G, J, M, L, D, E, H, C, R;
  k = function(a) {
    s(a, function(a) {
  ...
  return{clear:function() {
    ...
    purchaseDate:Kharma.l10n.pkg.purchaseDate, filter:Kharma.l10n.pkg.filter, status:Kharma.l10n.pkg.status, subcategory:Kharma.l10n.pkg.subcategory, title:Kharma.l10n.pkg.title, updateAll:Kharma.l10n.button.updateAll})), h.setTemplate(c), $("#mainContent").on(Kharma.utils.events.onDownloadProgress, function(a, b, c, d, e) {
      z(b, c, d, e)
...
Kharma.UI.DownloadButton = function(g) {
  var h, a = !1, d = $("<button class='download'></button>"), c = g || {}, e = c.content, b = (g = e && e.link) && g.id, f = !1, i = g && g.type, l, j = e && e.price ? e.price : null, k = e && e.upgrade_package && e.upgrade_package.indexOf("_") !== -1, n = e && k && e.upgrade_package ? e.upgrade_package.substr(0, e.upgrade_package.indexOf("_")) : e && e.upgrade_package, m = e && e.price_upgrade && n && e.price_upgrade[n], p, q, r = e && e.purchased_at && j && e.category && e.category.multiple === 
  "Y" ? !0 : !1, t, s, w, z, u, v, o, x, B, A;
  t = function() {
    $("#mainContent").on(Kharma.utils.events.onDownloadProgress, function(a, c, d, e, f) {
      i === c.type && b === c.id && o(c, d, e, f)
    });
    ...
    d.off().on("click", function(c) {
      ...
      c.stopPropagation();
      c.preventDefault();
      if(Kharma.login && Kharma.login.user && Kharma.login.user.is_anonymous && q !== "inBrowser") {
        q === "noPurchase" ? Kharma.utils.windowWrapper.open(d.attr("href"), "_blank") : (new Kharma.LoginDialog).show()
      }else {
        if(q === "inBrowser") {
          c = $.cookie("kharma_click_id"), c = typeof c === "string" && c.length > 0 ? "?kharma_click_id=" + c : "", Kharma.utils.windowWrapper.location.setHref("com.unity3d.kharma:content/" + b + c)
        }else {
          ...
          switch(q) {
            case "noPurchase":
              ...
              }}]}, h, g)) : Kharma.utils.windowWrapper.open(d.attr("href"), "_blank") : Kharma.utils.windowWrapper.open(d.attr("href"), "_blank");
              break;
            case "download":
            ;
            case "update":
            ...
            case "import":
              Kharma.io.get({uri:"/api/content/user-overview/" + b + ".json", onSuccess:function(a) {
                Kharma.download.importPackage(l, a.json.content.is_complete_project)
              }});
              break;
            case "buy":
            ;
    ...
    Kharma.utils.windowWrapper.onResize(t)
  };
  s = function() {
  ...
  w = function() {
    ...
    a && !e.last_downloaded_at ? (f = !0, B(a)) : u()
  };
  z = function() {
  ...
  u = function() {
    ...
    !e.license || a ? (d.text(Kharma.l10n.button.wait), Kharma.io.get({uri:"/api/" + c + "/download/" + b + ".json", onSuccess:function(a) {
      a.json.error ? o({type:c, id:b}, "Error: " + a.json.error, 0, 1) : Kharma.unityEditor.download(a.json.download, function(a) {
        if(a) {
          throw a.message;
        }
      })
  ...
  v = function() {
    e && e.flags && e.flags.no_purchase && !e.can_download ? (q = "noPurchase", x()) : !Kharma.unityEditor.isEditor() && !Kharma.unityEditor.isEmulated() ? (m && !e.can_download && !k ? (q = "upgrade", h.addClass("green")) : e && !e.can_download && j ? (q = "buy", h.addClass("green")) : q = "inBrowser", x()) : Kharma.download.findLocalPath(b, function(a) {
      m && !k && !e.can_download && parseFloat(j.substr(1)) > parseFloat(Kharma.helper.getFormattedPrice(m).substr(1)) ? (q = "upgrade", h.addClass("green")) : e.can_update ? (q = "update", h.addClass("update")) : a ? (q = "import", l = a) : e.can_download ? q = "download" : j ? (q = "buy", h.addClass("green")) : q = "download";
      x()
    })
  };
  o = function(a, c, e, g) {
    ...
    q = c;
    q === "connecting" ? d.text(a + "%") : q === "downloading" ? a && (d.text(a + "%"), p.css("width", a + "%")) : q.indexOf("Error") !== -1 ? (d.text(Kharma.l10n.error.error), d.attr("title", q), p.addClass("error")) : q === "ok" && ($("#mainContent").off(Kharma.utils.events.onDownloadProgress), f && Kharma.download.findLocalPath(b, function(a) {
  ...
  x = function() {
    switch(q) {
      ...
      case "update":
        ...
        break;
      case "buy":
        d.text(j === "Free" || k ? Kharma.l10n.button.get : Kharma.l10n.button.buy);
        d.attr("href", "#!/content/" + b + "/basketpurchase");
        break;
      case "upgrade":
        parseFloat(e.price.USD) < parseFloat(e.price_upgrade[n].USD) ? d.text(Kharma.l10n.button.buy) : (d.addClass("upgrade"), d.text(Kharma.l10n.pkg.upgrade + " " + Kharma.helper.getFormattedPrice(m))), d.attr("href", "#!/content/" + b + "/basketpurchase")
    }
  };
  B = function(a) {
    ...
    Kharma.io.get({uri:"/api/content/license/" + b + ".json", onSuccess:function(b) {
      if(b.transport.status === 200) {
        ...
        c && new Kharma.TextMessage({title:Kharma.l10n.page.license, message:c.result.license, withCancel:!0, callback:function(b) {
          b && (f = a = !0, d.text(Kharma.l10n.button.wait), w())
        }})
      }
    }})
  };
  h = $("<div class='action-container'></div>");
  p = $("<div class='progress-bar'></div>");
  h.append(p);
  h.append(d);
  c.targetElement.prepend(h);
  r && c.targetElement.append($("<br><div class='license-container'><button class='licenses'>" + Kharma.l10n.page.buyAdditionalLicenses + "</button></div>"));
  j && (j = Kharma.helper.getMinimumPrice(j, Kharma.login && Kharma.login.user && Kharma.login.user.roles && Kharma.login.user.roles.level11member && e && e.price_level11member), j = Kharma.helper.getMinimumPrice(j, Kharma.login && Kharma.login.user && Kharma.login.user.roles && Kharma.login.user.roles.assetkitsplusmember && e && e.price_assetkitsplusmember), j = Kharma.helper.getMinimumPrice(j, Kharma.login && Kharma.login.user && Kharma.login.user.roles && Kharma.login.user.roles.assetkitspromember && 
  e && e.price_assetkitspromember), j = Kharma.helper.getFormattedPrice(j));
  v();
  t()
};
...
Kharma.UI.ScreenShot = function(g) {
  var h = null, a, d, c, e, b = 0, f, i, l, j, k, n, m, p, q, r, t, s, w, z, u, v, o, x = {}, B = [140, 126, 119, 91, 71], A = [5, 5, 5, 4, 3], y;
  p = function(a, b) {
    function c(a) {
  ...
  r = function(a) {
    ...
    $.each(a, function(a, d) {
      ...
      $(f[0]).on("click", function(a) {
        ...
        a.stopPropagation();
        if(c !== d) {
          if(c = d, e = b.attr("data-type"), x[b.attr("data-full")]) {
            w(x[b.attr("data-full")])
          }else {
  ...
  s = function(a) {
    ...
    b.append(c);
    x[a.attr("data-full")] = b;
    w(b);
    m.hide()
  };
  w = function(a) {
    var e = a.children().first(), g = a.attr("data-type"), l = n.children().last(), j = l.attr("data-type"), m = 0, q = k[c], p = A[f()];
    n.append(a);
    ...
    h = i.find("#active-bg");
    h.length === 0 ? (h = $("<div id='active-bg' />"), i.prepend(h), h.css({width:q.width() + 10, left:q.position().left + parseInt(q.css("margin-left"), 10) - 5}), h.fadeIn()) : h.animate({width:q.width() + 10, left:q.position().left + parseInt(q.css("margin-left"), 10) - 5}, 200);
    c - b >= p ? z(c - b - (p - 1)) : c < b && z(c - b)
  };
  f = function() {
...
Kharma.UI.Slider = function(g) {
  ...
  l = function(a, c, d) {
    ...
    e === "assetkits" ? (l.append(j), f.append(l), j.append('<div class="pre-header">ASSET KIT</div>'), j.append("<h1>" + a.title + "</h1>"), j.append('<div class="description">' + a.description + "</div>"), t = $('<div class="includes"><h2>Pack includes</h2></div>'), j.append(t), $.each(a.packages, function(a, b) {
    ...
    d + "</div>"), j.append(d), f.prepend($('<a href="' + a.url + '" class="livelink"></a>').css({display:"block", height:"100%"}))) : a.flags && !a.flags.no_text_on_big_keyimage && a.link && a.link.type !== "banner" ? (g.addSaleBanner(a, f), l.append(j), f.append(l), h.createFull({element:j, data:a, callback:function() {
      h.setExternalLinks("fulldescription")
    }, level11:a.price_level11member}), $(j.find("h1")).empty().append($('<a href="#!/content/' + a.id + '" class="livelink">' + a.title + "</a>"))) : (l.hide(), (a.flags && a.flags.override_url || a.link && a.link.type === "banner") && f.prepend($('<a href="' + a.url + '" class="livelink"></a>').css({display:"block", height:"100%"})));
...
(function() {
  ...
  h.browserMenu = g({compiler:[6, ">= 2.0.0-beta.1"], main:function(a, d, c, e) {
    ...
    d.roadMapLink || (a != null ? a.roadMapLink : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"roadMapLink", hash:{}, data:e}) : b)) + '">' + f((b = (b = d.roadMap || (a != null ? a.roadMap : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"roadMap", hash:{}, data:e}) : b)) + '</a></li>\n            <li class="last"><a href="' + f((b = (b = d.helpLink || (a != null ? a.helpLink : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"helpLink", hash:{}, 
    data:e}) : b)) + '">' + f((b = (b = d.help || (a != null ? a.help : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"help", hash:{}, data:e}) : b)) + '</a></li>\n            <li class="right"><a href="/en" lang="en-US" hreflang="en">English</a></li>\n            <li class="right"><a href="/jp" lang="ja-JP" hreflang="ja">\u65e5\u672c\u8a9e</a></li>\n            <li class="right"><a href="/kr" lang="ko-KR" hreflang="ko">\ud55c\uad6d\uc5b4</a></li>\n            <li class="right"><a href="/cn" lang="zh-CN" hreflang="cn">\u7b80\u4f53\u4e2d\u6587</a></li>\n        </ul>\n    </div>\n    <nav class="mobile-menu">\n        <div class="wrap">\n            <div class="unav-menu">\n                <h2>' + 
    ...
    '">' + f((b = (b = d.linkMaker || (a != null ? a.linkMaker : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"linkMaker", hash:{}, data:e}) : b)) + '</a></li>\n                            <li><a href="' + f((b = (b = d.roadMapLink || (a != null ? a.roadMapLink : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"roadMapLink", hash:{}, data:e}) : b)) + '">' + f((b = (b = d.roadMap || (a != null ? a.roadMap : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"roadMap", 
    hash:{}, data:e}) : b)) + '</a></li>\n                            <li class="last"><a href="' + f((b = (b = d.helpLink || (a != null ? a.helpLink : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"helpLink", hash:{}, data:e}) : b)) + '">' + f((b = (b = d.help || (a != null ? a.help : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"help", hash:{}, data:e}) : b)) + '</a></li>\n                        </ul>\n                    </li>\n                </ul>\n                <div class="lang">\n                    <h2>' + 
    f((b = (b = d.language || (a != null ? a.language : a)) != null ? b : c, typeof b === "function" ? b.call(a, {name:"language", hash:{}, data:e}) : b)) + '</h2>\n                    <ul>\n                        <li><a href="/en" lang="en-US" hreflang="en">English</a></li>\n                        <li><a href="/jp" lang="ja-JP" hreflang="ja">\u65e5\u672c\u8a9e</a></li>\n                        <li><a href="/kr" lang="ko-KR" hreflang="ko">\ud55c\uad6d\uc5b4</a></li>\n                    </ul>\n                </div>\n            </div>\n        </div>\n    </nav>\n</div>\n'
  }, useData:!0});
  ...
  h.purchaseDialog = g({"1":function(a, d, c, e) {
    ...
    b != null && (h += b);
    h += '                <option value="genesis">' + g((f = (f = d.creditCard || (a != null ? a.creditCard : a)) != null ? f : c, typeof f === "function" ? f.call(a, {name:"creditCard", hash:{}, data:e}) : f)) + "</option>\n            </select>\n        </div>\n\n";
