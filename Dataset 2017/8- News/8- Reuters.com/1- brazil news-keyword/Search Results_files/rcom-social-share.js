...
Reuters.share = {
    ...
    configureSharetools: function(el) {
        ...
        if (this.edition == "BETACN" || this.edition == "CN" || Reuters.info.edition == "BETACN"){
            ...
            this.mailTxtLink    = '您可以通过邮箱订制新闻资讯，请在此订制 http://reut.rs/1bB38fv.';
        } else if (this.edition == "UK" || Reuters.info.edition == "UK"){
            ...
            this.mailTxtBody    = 'I thought you would be interested in the following:';
            this.mailTxtLink    = 'If you would like to receive news articles delivered to your email address, please subscribe at http://reut.rs/1Krh3AZ.';
            ...
            this.mailTxtBody    = 'I thought you would be interested in the following:';
            this.mailTxtLink    = 'If you would like to receive news articles delivered to your email address, please subscribe at http://www.reuters.com/newsmails.';
        }
        this.shareObj   = {
            "twitter": {
