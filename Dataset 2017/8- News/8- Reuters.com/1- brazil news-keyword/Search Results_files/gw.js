...
asi_makeGIF('//pix04.revsci.net/G10937/a4/0/0/0.302?matchId=adnxs-1044');
...
function createRSIActivateCB(custCode){
    return asi_addOnSegs(function(userSegs,csid){
      if (csid == custCode) { asi_addElem(asi_makeJS('//direct.revsci.net/actvt')); }
   });
};
var DM_onSegsAvailable = createRSIActivateCB(rsi_csid.toLowerCase());
asi_makeGIF('//aa.agkn.com/adscores/g.pixel?sid=9212268988');
