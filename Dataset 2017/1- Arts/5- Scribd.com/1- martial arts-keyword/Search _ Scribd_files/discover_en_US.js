/* :asset_packager_compatibility, 'config/asset_packages.yml' @ 1485296272 */
...
/* :files, 'app/views', ... @ 1485296271 */
/* app/views/discover/shared.coffee @ 1485296271 */
(function(){var t=function(t,n){function r(){this.constructor=t}for(var i in n)e.call(n,i)&&(t[i]=n[i]);return r.prototype=n.prototype,t.prototype=new r,t.__super__=n.prototype,t},e={}.hasOwnProperty;Scribd.Discover={Modules:{},UI:{},Tracking:{}},Scribd.Discover.UI.DiscoverCarousel=function(e){function n(t,e){this.container=t,this.opts=null!=e?e:{},n.__super__.constructor.apply(this,arguments)}return t(n,e),n}(Scribd.UI.Carousel)}).call(this);


/* :class_inlines, 'app/views', ... @ 1485296271 */
/* app/views/discover/modules/article_row.coffee @ 1485296271 */
...
/* app/views/discover/modules/base.coffee @ 1485296271 */
...
/* app/views/discover/modules/featured_document.coffee @ 1485296271 */
...
/* app/views/discover/modules/hero_banner.coffee @ 1485296271 */
(function(){var t=function(t,n){function r(){this.constructor=t}for(var i in n)e.call(n,i)&&(t[i]=n[i]);return r.prototype=n.prototype,t.prototype=new r,t.__super__=n.prototype,t},e={}.hasOwnProperty;Scribd.HeroBanner=function(e){function n(t,e){this.opts=null!=e?e:{},this.container=$(t),this.filter_list=this.container.find(".filter_list"),this.filter_current_btn=this.container.find(".filter_current_btn"),this.setup_click_events(),n.__super__.constructor.call(this,t,this.opts)}return t(n,e),n.prototype.setup_click_events=function(){return this.container.dispatch("click",{filter_current_btn:function(t){return function(){return t.filter_current_btn.hide(),t.filter_list.show()}}(this),filter_item:function(t){return function(e){var n;return e.siblings().removeClass("selected"),e.addClass("selected"),n=e.text(),t.filter_current_btn.find(".filter_title").text(n).show(),t.filter_list.hide(),"continue"}}(this)}),$(document).click(function(t){return function(){return t.filter_list.hide(),t.filter_current_btn.show()}}(this))},n}(Scribd.Discover.Modules.Base)}).call(this),(Scribd.translations=Scribd.translations||[]).push({en_US:{discover:{modules:{hero_banner:{browse:"Browse",please_agree_to_our_a_href_static_terms_url:"Please agree to our <a href=%{static_terms_url}> Terms of service </a>"}}}}});


/* app/views/discover/modules/interest_list.coffee @ 1485296271 */
...
/* app/views/discover/modules/single_article.coffee @ 1485296271 */
