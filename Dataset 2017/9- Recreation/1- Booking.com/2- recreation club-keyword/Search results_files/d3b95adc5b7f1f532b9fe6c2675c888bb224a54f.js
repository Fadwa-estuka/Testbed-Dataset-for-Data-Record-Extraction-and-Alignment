 ...
 */
function(e) {
var t, n, r, i, o, a, s, u, l, c, f, d, p, h, g, m, v, y, b, x = "sizzle" + 1 * new Date(), w = e.document, T = 0, C = 0, N = se(), E = se(), k = se(), S = function(e, t) {
return e === t && (f = !0), 0;
}, j = 1 << 31, A = {}.hasOwnProperty, D = [], L = D.pop, H = D.push, _ = D.push, q = D.slice, M = function(e, t) {
for (var n = 0, r = e.length; r > n; n++) if (e[n] === t) return n;
return -1;
}, F = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", O = "[\\x20\\t\\r\\n\\f]", B = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", R = B.replace("w", "w#"), W = "\\[" + O + "*(" + B + ")(?:" + O + "*([*^$|!~]?=)" + O + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + O + "*\\]", P = ":(" + B + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", $ = new RegExp(O + "+", "g"), z = new RegExp("^" + O + "+|((?:^|[^\\\\])(?:\\\\.)*)" + O + "+$", "g"), I = new RegExp("^" + O + "*," + O + "*"), X = new RegExp("^" + O + "*([>+~]|" + O + ")" + O + "*"), Q = new RegExp("=" + O + "*([^\\]'\"]*?)" + O + "*\\]", "g"), U = new RegExp(P), J = new RegExp("^" + R + "$"), V = {
ID:new RegExp("^#(" + B + ")"),
CLASS:new RegExp("^\\.(" + B + ")"),
...
}, G = /^(?:input|select|textarea|button)$/i, Y = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = /'|\\/g, ne = new RegExp("\\\\([\\da-f]{1,6}" + O + "?|(" + O + ")|.)", "ig"), re = function(e, t, n) {
var r = "0x" + t - 65536;
...
T = ee.test(e) && ge(t.parentNode) || t, C = h.join(",");
}
if (C) try {
...
return p = a, h = a.documentElement, i = a.defaultView, i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", ie, !1) :i.attachEvent && i.attachEvent("onunload", ie)), g = !o(a), n.attributes = le(function(e) {
...
if ((e.ownerDocument || e) !== p && d(e), t = t.replace(Q, "='$1']"), n.matchesSelector && g && (!v || !v.test(t)) && (!m || !m.test(t))) try {
var r = y.call(e, t);
...
for (c = m[x] || (m[x] = {}), l = c[e] || [], p = l[0] === T && l[1], d = l[0] === T && l[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (d = p = 0) || h.pop(); ) if (1 === f.nodeType && ++d && f === t) {
c[e] = [ T, p, d ];
break;
}
} else if (y && (l = (t[x] || (t[x] = {}))[e]) && l[0] === T) d = l[1]; else for (;(f = ++p && f && f[g] || (d = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v :1 !== f.nodeType) || !++d || (y && ((f[x] || (f[x] = {}))[e] = [ T, d ]), f !== t)); ) ;
...
var l, c, f, d = [], p = [], h = a.length, g = o || xe(t || "*", s.nodeType ? [ s ] :s, []), m = !e || !o && t ? g :we(g, d, e, s, u), v = n ? i || (o ? e :h || r) ? [] :a :m;
if (n && n(m, v, s, u), r) for (l = we(v, p), r(l, [], s, u), c = l.length; c--; ) (f = l[c]) && (v[p[c]] = !(m[p[c]] = f));
if (o) {
if (i || e) {
if (i) {
...
var f, d, h, g = 0, m = "0", v = o && [], y = [], b = l, x = o || i && r.find.TAG("*", c), w = T += null == b ? 1 :Math.random() || .1, C = x.length;
for (c && (l = a !== p && a); m !== C && null != (f = x[m]); m++) {
if (i && f) {
...
if (o) {
if (g > 0) for (;m--; ) v[m] || y[m] || (y[m] = L.call(u));
y = we(y);
}
_.apply(u, y), c && !o && y.length > 0 && g + t.length > 1 && ae.uniqueSort(u);
}
return c && (T = w, l = b), v;
};
return n ? ue(o) :o;
...
for (u = V.needsContext.test(e) ? 0 :l.length; u-- && (c = l[u], !r.relative[f = c.type]); ) if ((d = r.find[f]) && (o = d(c.matches[0].replace(ne, re), ee.test(l[0].type) && ge(t.parentNode) || t))) {
if (l.splice(u, 1), e = o.length && ve(l), !e) return _.apply(i, o), i;
break;
}
}
return (p || s(e, h))(o, t, !g, i, ee.test(e) && ge(t.parentNode) || t), i;
...
var F, O = "undefined";
for (F in d(c)) break;
c.ownLast = "0" !== F, c.inlineBlockNeedsLayout = !1, d(function() {
var e, t, n, r;
if (n = N.getElementsByTagName("body")[0], !n || !n.style) return;
t = N.createElement("div"), r = N.createElement("div"), r.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", n.appendChild(r).appendChild(t), typeof t.style.zoom !== O && (t.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1", c.inlineBlockNeedsLayout = e = 3 === t.offsetWidth, e && (n.style.zoom = 1)), n.removeChild(r);
}), function() {
...
hasData:function(e) {
return e = e.nodeType ? d.cache[e[d.expando]] :e[d.expando], !!e && !P(e);
},
data:function(e, t, n) {
return $(e, t, n);
},
...
for (n = a.length; n--; ) a[n] && (r = a[n].name, 0 === r.indexOf("data-") && (r = d.camelCase(r.slice(5)), W(o, r, i[r])));
...
var V = /^(?:input|select|textarea)$/i, G = /^key/, Y = /^(?:mouse|pointer|contextmenu)|click/, K = /^(?:focusinfocus|focusoutblur)$/, Z = /^([^.]*)(?:\.(.+)|)$/;
function ee() {
return !0;
}
function te() {
...
if (o = Z.exec(t[s]) || [], h = m = o[1], g = (o[2] || "").split(".").sort(), !h) continue;
...
namespace:g.join(".")
}, u), (p = a[h]) || (p = a[h] = [], p.delegateCount = 0, l.setup && l.setup.call(e, r, g, c) !== !1 || (e.addEventListener ? e.addEventListener(h, c, !1) :e.attachEvent && e.attachEvent("on" + h, c))), l.add && (l.add.call(e, f), f.handler.guid || (f.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, f) :p.push(f), d.event.global[h] = !0;
}
e = null;
},
...
if (s = Z.exec(t[l]) || [], h = m = s[1], g = (s[2] || "").split(".").sort(), !h) {
for (h in c) d.event.remove(e, h + t[l], n, r, !0);
continue;
}
for (f = d.event.special[h] || {}, h = (r ? f.delegateType :f.bindType) || h, p = c[h] || [], s = s[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = p.length; o--; ) a = p[o], !i && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (p.splice(o, 1), a.selector && p.delegateCount--, f.remove && f.remove.call(e, a));
u && !p.length && (f.teardown && f.teardown.call(e, g, v.handle) !== !1 || d.removeEvent(e, h, v.handle), delete c[h]);
}
d.isEmptyObject(c) && (delete v.handle, d._removeData(e, "events"));
},
trigger:function(t, n, r, i) {
var o, a, s, u, c, f, p, h = [ r || N ], g = l.call(t, "type") ? t.type :t, m = l.call(t, "namespace") ? t.namespace.split(".") :[];
if (s = f = r = r || N, 3 === r.nodeType || 8 === r.nodeType) return;
if (K.test(g + d.event.triggered)) return;
if (g.indexOf(".") >= 0 && (m = g.split("."), g = m.shift(), m.sort()), a = g.indexOf(":") < 0 && "on" + g, t = t[d.expando] ? t :new d.Event(g, "object" == typeof t && t), t.isTrigger = i ? 2 :3, t.namespace = m.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") :null, t.result = void 0, t.target || (t.target = r), n = null == n ? [ t ] :d.makeArray(n, [ t ]), c = d.event.special[g] || {}, !i && c.trigger && c.trigger.apply(r, n) === !1) return;
if (!i && !c.noBubble && !d.isWindow(r)) {
for (u = c.delegateType || g, K.test(u + g) || (s = s.parentNode); s; s = s.parentNode) h.push(s), f = s;
f === (r.ownerDocument || N) && h.push(f.defaultView || f.parentWindow || e);
}
for (p = 0; (s = h[p++]) && !t.isPropagationStopped(); ) t.type = p > 1 ? u :c.bindType || g, o = (d._data(s, "events") || {})[t.type] && d._data(s, "handle"), o && o.apply(s, n), o = a && s[a], o && o.apply && d.acceptData(s) && (t.result = o.apply(s, n), t.result === !1 && t.preventDefault());
if (t.type = g, !i && !t.isDefaultPrevented() && (!c._default || c._default.apply(h.pop(), n) === !1) && d.acceptData(r) && a && r[g] && !d.isWindow(r)) {
f = r[a], f && (r[a] = null), d.event.triggered = g;
try {
r[g]();
} catch (v) {}
...
for (a || (this.fixHooks[i] = a = Y.test(i) ? this.mouseHooks :G.test(i) ? this.keyHooks :{}), r = a.props ? this.props.concat(a.props) :this.props, e = new d.Event(o), t = r.length; t--; ) n = r[t], e[n] = o[n];
...
for (var i, o, a, s, u, l, f, p = e.length, h = re(t), g = [], m = 0; p > m; m++) if (o = e[m], o || 0 === o) if ("object" === d.type(o)) d.merge(g, o.nodeType ? [ o ] :o); else if (fe.test(o)) {
...
if (!c.leadingWhitespace && se.test(o) && g.push(t.createTextNode(se.exec(o)[0])), !c.tbody) for (o = "table" !== u || ce.test(o) ? "<table>" !== f[1] || ce.test(o) ? 0 :s :s.firstChild, i = o && o.childNodes.length; i--; ) d.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l);
for (d.merge(g, s.childNodes), s.textContent = ""; s.firstChild; ) s.removeChild(s.firstChild);
s = h.lastChild;
} else g.push(t.createTextNode(o));
for (s && h.removeChild(s), c.appendChecked || d.grep(xe(g, "input"), we), m = 0; o = g[m++]; ) {
...
l[o] && (delete l[o], f ? delete r[u] :typeof r.removeAttribute !== O ? r.removeAttribute(u) :r[u] = null, n.push(o));
}
}
}), d.fn.extend({
text:function(e) {
...
e = i.apply([], e);
var n, r, o, a, s, u, l = 0, f = this.length, p = this, h = f - 1, g = e[0], m = d.isFunction(g);
if (m || f > 1 && "string" == typeof g && !c.checkClone && pe.test(g)) return this.each(function(n) {
var r = p.eq(n);
...
if (o) for (s = a[a.length - 1].ownerDocument, d.map(a, Ne), l = 0; o > l; l++) r = a[l], he.test(r.type || "") && !d._data(r, "globalEval") && d.contains(s, r) && (r.src ? d._evalUrl && d._evalUrl(r.src) :d.globalEval((r.text || r.textContent || r.innerHTML || "").replace(me, "")));
u = n = null;
}
return this;
}
...
var t, n, r;
if (n = N.getElementsByTagName("body")[0], !n || !n.style) return;
return t = N.createElement("div"), r = N.createElement("div"), r.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", n.appendChild(r).appendChild(t), typeof t.style.zoom !== O && (t.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1", t.appendChild(N.createElement("div")).style.width = "5px", e = 3 !== t.offsetWidth), n.removeChild(r), e;
};
}();
var He, _e, qe = /^margin/, Me = new RegExp("^(" + I + ")(?!px)[a-z%]+$", "i"), Fe = /^(top|right|bottom|left)$/;
...
var r, i, o, a, s = e.style;
return n = n || He(e), a = n ? n[t] :void 0, null == a && s && s[t] && (a = s[t]), Me.test(a) && !Fe.test(t) && (r = s.left, i = e.runtimeStyle, o = i && i.left, o && (i.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em" :a, a = s.pixelLeft + "px", s.left = r, o && (i.left = o)), void 0 === a ? a :a + "" || "auto";
});
function Oe(e, t) {
return {
get:function() {
...
var Be = /alpha\([^)]*\)/i, Re = /opacity\s*=\s*([^)]*)/, We = /^(none|table(?!-c[ea]).+)/, Pe = new RegExp("^(" + I + ")(.*)$", "i"), $e = new RegExp("^([+-])=(" + I + ")", "i"), ze = {
position:"absolute",
visibility:"hidden",
display:"block"
}, Ie = {
...
d.cssHooks[t] = {
get:function(e, n, r) {
if (n) return We.test(d.css(e, "display")) && 0 === e.offsetWidth ? d.swap(e, ze, function() {
return Ge(e, t, r);
}) :Ge(e, t, r);
},
set:function(e, n, r) {
...
function ut(e, t, n) {
var r, i, o, a, s, u, l, f, p = this, h = {}, g = e.style, m = e.nodeType && Q(e), v = d._data(e, "fxshow");
...
})), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [ g.overflow, g.overflowX, g.overflowY ], l = d.css(e, "display"), f = "none" === l ? d._data(e, "olddisplay") || Le(e.nodeName) :l, "inline" === f && "none" === d.css(e, "float") && (c.inlineBlockNeedsLayout && "inline" !== Le(e.nodeName) ? g.zoom = 1 :g.display = "inline-block")), n.overflow && (g.overflow = "hidden", c.shrinkWrapBlocks() || p.always(function() {
...
if (d.isEmptyObject(h)) "inline" === ("none" === l ? Le(e.nodeName) :l) && (g.display = l); else {
v ? "hidden" in v && (m = v.hidden) :v = d._data(e, "fxshow", {}), o && (v.hidden = !m), m ? d(e).show() :p.done(function() {
d(e).hide();
}), p.done(function() {
var t;
...
for (r in h) a = st(m ? v[r] :0, r, p), r in v || (v[r] = a.start, m && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 :0));
}
}
function lt(e, t) {
var n, r, i, o, a;
...
var dt, pt, ht = d.expr.attrHandle, gt = /^(?:checked|selected)$/i, mt = c.getSetAttribute, vt = c.input;
d.fn.extend({
attr:function(e, t) {
...
if (typeof e.getAttribute === O) return d.prop(e, t, n);
...
if (o && 1 === e.nodeType) for (;n = o[i++]; ) r = d.propFix[n] || n, d.expr.match.bool.test(n) ? vt && mt || !gt.test(n) ? e[r] = !1 :e[d.camelCase("default-" + n)] = e[r] = !1 :d.attr(e, n, ""), e.removeAttribute(mt ? n :r);
},
attrHooks:{
type:{
set:function(e, t) {
...
set:function(e, t, n) {
return t === !1 ? d.removeAttr(e, n) :vt && mt || !gt.test(n) ? e.setAttribute(!mt && d.propFix[n] || n, n) :e[d.camelCase("default-" + n)] = e[n] = !0, n;
}
}, d.each(d.expr.match.bool.source.match(/\w+/g), function(e, t) {
var n = ht[t] || d.find.attr;
ht[t] = vt && mt || !gt.test(t) ? function(e, t, r) {
var i, o;
...
return this.each(function() {
if ("string" === n) for (var t, r = 0, i = d(this), o = e.match(D) || []; t = o[r++]; ) i.hasClass(t) ? i.removeClass(t) :i.addClass(t); else (n === O || "boolean" === n) && (this.className && d._data(this, "__className__", this.className), this.className = this.className || e === !1 ? "" :d._data(this, "__className__") || "");
});
},
hasClass:function(e) {
...
var n, r, i, o, a, s, u, l, c = d.ajaxSetup({}, t), f = c.context || c, p = c.context && (f.nodeType || f.jquery) ? d(f) :d.event, h = d.Deferred(), g = d.Callbacks("once memory"), m = c.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
readyState:0,
...
var l, v, y, x, T, C = t;
if (2 === b) return;
b = 2, a && clearTimeout(a), u = void 0, o = r || "", w.readyState = e > 0 ? 4 :0, l = e >= 200 && 300 > e || 304 === e, n && (x = Wt(c, w, n)), x = Pt(c, x, w, l), l ? (c.ifModified && (T = w.getResponseHeader("Last-Modified"), T && (d.lastModified[i] = T), T = w.getResponseHeader("etag"), T && (d.etag[i] = T)), 204 === e || "HEAD" === c.type ? C = "nocontent" :304 === e ? C = "notmodified" :(C = x.state, v = x.data, y = x.error, l = !y)) :(y = C, (e || !C) && (C = "error", 0 > e && (e = 0))), w.status = e, w.statusText = (t || C) + "", l ? h.resolveWith(f, [ v, C, w ]) :h.rejectWith(f, [ w, C, y ]), w.statusCode(m), m = void 0, s && p.trigger(l ? "ajaxSuccess" :"ajaxError", [ w, c, l ? v :y ]), g.fireWith(f, [ w, C ]), s && (p.trigger("ajaxComplete", [ w, c ]), --d.active || d.event.trigger("ajaxStop"));
}
return w;
},
...
var Jt = 0, Vt = {}, Gt = d.ajaxSettings.xhr();
e.attachEvent && e.attachEvent("onunload", function() {
for (var e in Vt) Vt[e](void 0, !0);
}), c.cors = !!Gt && "withCredentials" in Gt, Gt = c.ajax = !!Gt, Gt && d.ajaxTransport(function(e) {
...
return typeof i.getBoundingClientRect !== O && (r = i.getBoundingClientRect()), n = rn(o), {
...
function i(n) {
var i = t.console;
r[n] || (r[n] = t.enableRemoveMigrateWarns ? !1 :!0, e.migrateWarnings.push(n), i && i.error && !e.migrateMute && (i.error(n), e.migrateTrace && i.trace && i.trace()), "B" in t && B.reportError && B.et && B.et.track("cLOeaaAJDfNJcCcCcCC") && B.reportError({
message:n
}, "jQuery Migrate"));
}
function o(t, n, r, o) {
...
var o;
if (t && "string" == typeof t && !e.isPlainObject(n) && (o = y.exec(e.trim(t))) && o[0] && ("#" === o[0].charAt(0) && (i("HTML string cannot start with a '#' character"), e.error("JQMIGRATE: Invalid selector string (XSS)")), n && n.context && (n = n.context), e.parseHTML)) return m.call(this, e.parseHTML(o[2], n, !0), n, r);
...
}, e.browser || (h = e.uaMatch(navigator.userAgent), g = {}, h.browser && (g[h.browser] = !0, g.version = h.version), g.chrome ? g.webkit = !0 :g.webkit && (g.safari = !0), e.browser = g), o(e, "browser", e.browser, "jQuery.browser is deprecated"), e.sub = function() {
function t(e, n) {
