...
O(Object, {
keys:function(t) {
var n = e(t), r = j(t), o = null !== t && "object" == typeof t, i = o && T(t);
...
"use strict";
if (t.jstmpl) return;
var n, r, o, i, a, u, s, f, c, l, p, h, v, d, g, m, _, y, w, b, T, E, N, x, j, O, I, A, S, k, R, B, C, L, D, M, G, q = [], F = 42;
u = function(e, t) {
...
}, g = new Array(F), d = function(e, t, n) {
var r = 0;
for (t.length; ;) {
var o = t.indexOf("{", r);
if (-1 === o) {
...
if (e.jstmpl.translations) return;
var t, n, r, o, i, a, u = e.jstmpl, t = function(e, t, n, o) {
var i = 0, a = !(0 !== o && !o);
if (a) {
...
if (!e) return "";
var i = e.split(" ").slice(0, 2), a = (o || "").split(" ").slice(0, 2), u = {
date:i[0],
time:i[1],
date_until:a[0],
time_until:a[1],
...
return B.require("utils/string-interpolate")(B.require("formatting/date").locale_format(u), {
begin_marker:n,
end_marker:r
});
}, a = function(t) {
...
function a(e) {
i(e), "string" == typeof e ? (i(e), r()) :e instanceof Array && (e.forEach(i), r()), I.m && (I.m += "," + e);
}
return {
populate:a
};
...
function h(e) {
var t = e.url, n = e.complete || function() {}, r = e.headers || {};
if (!t) return !1;
var o = new XMLHttpRequest();
o.open("GET", t, !0);
var i;
if (r) for (i in r) r.hasOwnProperty(i) && o.setRequestHeader(i, "function" == typeof r[i] ? r[i].call() :r[i]);
o.onreadystatechange = function() {
o.readyState === XMLHttpRequest.DONE && n(o, o.status);
}, o.send();
}
function v() {
r.level && r.report(r.events.BEACON_SENT, f), i = !1, l = 0, t = null, f.length && g();
}
function d() {
l++, i = !1, t = null, l >= s ? c = [] :(f = f.concat(c), c = [], t = window.setTimeout(g, l * u));
}
function g() {
r.level && r.report(r.events.SEND_BEACON, f.slice(0)), i = !0, c = f;
var t = n + "&" + p(c);
I.m && (t += "&m=" + encodeURIComponent(I.m)), f = [];
try {
b ? h({
url:t,
...
var a = new Image();
a.onload = v, a.onerror = d, a.src = n;
}
}
function m(e, n, o) {
r.level && r.report(r.events.INIT_BEACON, e, n, o), 0 === arguments.length, f.push({
what:e,
hash:n,
id:o
}), i || t ? r.level && r.report(r.events.DEFER_BEACON, f) :t = window.setTimeout(g, a);
}
return m;
}(), h = {}, v = 300, d = {}, g = [], m = !1, _ = !1, y = !1, w = !1, b = !1, T = !1, E = {}, N = !1, x = !1, j = "scroll resize", O = !1, I = {
r:{},
t:{},
f:{}
};
...
A[e] || (A[e] = [ [], [] ]);
var n = A[e][0], r = A[e][1];
if (r.length <= S + 10) return n.push(t), !0;
}
function R(e) {
if (!A[e] || !A[e][0].length) return;
var t = A[e][0], n = A[e][1], r = [ e, t.join(":") ];
...
hash:t,
id:n,
variant:(e === o.experiment || e === o.stage) && Y(t)
}), M(e, t, n)) switch (e) {
case o.experiment:
D(o.experiment, t), i.populate(t), p(o.experiment, t);
break;

case o.stage:
D(o.stage, t, n), i.populate(t + "|" + n), p(o.stage, t, n);
break;

case o.goal:
D(o.goal, t), p(o.goal, t);
break;

case o.customGoal:
D(o.customGoal, t, n), p(o.customGoal, t, n);
break;

case o.goalWithValue:
k(t, n) && p(o.goalWithValue, t, n);
break;

default:
r.level && r.report(r.events.TRACK_UNKNOWN_ITEM, e, t, n);
}
return e === o.experiment ? Y(t) :!0;
}
function D(e, t, n) {
d[B(e, t, n)] = !0;
}
...
if (d[B(e, t, n)]) return r.level && r.report(r.events.NOT_TRACKING_WAS_TRACKED, i), !1;
if (e === o.experiment || e === o.stage) {
var a = 1 << (n || 0), u = C(t);
if (I.f[u]) return r.level && r.report(r.events.NOT_TRACKING_FULLON, i), !1;
if (void 0 === I.r[u]) return r.level && r.report(r.events.NOT_TRACKING_NOT_RUNNING, i), !1;
if (I.t[u] & a) return D(e, t, n), r.level && r.report(r.events.NOT_TRACKING_WAS_TRACKED, i), !1;
...
function G(t, n, o, i, a) {
r.level && r.report(r.events.ADD_EVENT_LISTENER, t, n, o, i, a), l || (l = e(window));
var u = e(n).eq(0);
if ("view" !== t && (u = e(n)), !u.length) return void (r.level && r.report(r.events.NOT_EXISTING_ELEMENT_WONT_ADD_LISTENER, o, i, a));
function s() {
L(o, i, a);
}
"view" === t ? q(u, o, i, a) :u.one(t, s);
}
function q(e, t, n, o) {
r.level && r.report(r.events.ADD_DEBOUNCED_VIEW_HANDLER, e, t, n, o);
var i = B(t, n, o);
if (d[i]) return !1;
g.push([ e, t, n, o ]), m || (r.level && r.report(r.events.ATTACH_VIEW_LISTENER, g), l.bind("load", function() {
setTimeout(F, v);
}), setTimeout(F, v), l.bind(j, F), N && N(F), m = !0);
}
function F() {
if (_) return;
_ = !0;
var e = [], t = l.scrollTop(), n = l.height();
r.level && r.report(r.events.CHECK_IF_VISIBLE, g);
for (var o, i = 0, a = g.length; a > i; ++i) o = g[i], o && c(o[0], t, n) ? (r.level && r.report(r.events.ONVIEW_TRACKING_TRIGGERED, o[1], o[2], o[3]), L(o[1], o[2], o[3])) :e.push(o);
g = e, r.level && r.report(r.events.VISIBLE_CHECK_FINISHED, g), 0 === g.length && (m = !1, l.unbind(j, F), x && x(F), r.level && r.report(r.events.DETACH_VIEW_LISTENER)), window.setTimeout(function() {
_ = !1;
}, v);
}
...
var a = K(t);
if (a.length > 0) if ("view" === e) V(a[0], n, o, i); else {
function u() {
L(n, o, i);
for (var t = 0, r = a.length; r > t; t++) $(a[t], e, u);
}
for (var s = 0, f = a.length; f > s; s++) W(a[s], e, u);
...
var i = B(t, n, o);
if (d[i]) return !1;
g.push([ e, t, n, o ]), m || (r.level && r.report(r.events.ATTACH_VIEW_LISTENER, g), W(window, "scroll", H), W(window, "resize", H), m = !0);
}
function H() {
if (_) return;
_ = !0;
var e = [];
r.level && r.report(r.events.CHECK_IF_VISIBLE, g);
for (var t, n = 0, o = g.length; o > n; ++n) t = g[n], t && U(t[0]) ? (r.level && r.report(r.events.ONVIEW_TRACKING_TRIGGERED, t[1], t[2], t[3]), L(t[1], t[2], t[3])) :e.push(t);
g = e, r.level && r.report(r.events.VISIBLE_CHECK_FINISHED, g), 0 === g.length && (m = !1, $(window, "scroll", H), $(window, "resize", H), r.level && r.report(r.events.DETACH_VIEW_LISTENER)), window.setTimeout(function() {
_ = !1;
}, v);
}
function U(e) {
...
function z(e, t, n) {
return function(o, i) {
M(n, o, i) ? window.jQuery && !w ? G(e, t, n, o, i) :P(e, t, n, o, i) :r.level && r.report(r.events.WONT_ATTACH_EVENT_TRACKING, e, t, n, o, i);
};
}
function J(e, t) {
return {
track:z(e, t, o.experiment),
stage:z(e, t, o.stage),
goal:z(e, t, o.goal),
customGoal:z(e, t, o.customGoal)
};
}
function X(e, t) {
for (var n in t) t.hasOwnProperty(n) && (e[n] = t[n]);
...
function Z(e) {
I.f = e.f || {}, X(I.r, e.r || {}), X(I.t, e.t || {}), e.m && !I.m && (I.m = e.m);
}
function Y(e) {
var t = C(e);
...
if (!e) {
if (O) throw "B.et.track: hash value should be a non-empty string";
return 0;
}
return L(o.experiment, e);
}
function ee(e, t) {
if (!e) {
if (O) throw "B.et.trackStage: hash value should be a non-empty string";
return !1;
}
if (void 0 === t) {
if (O) throw "B.et.trackStage: stage number should be a number between 1 and 9";
return !1;
}
if (0 === t) return Q(e);
if (!/^[1-9]$/.test(t)) {
...
return L(o.stage, e, t);
}
function te(e) {
if (!e) {
if (O) throw "B.et.goal: name should be a non-empty string";
return !1;
}
return L(o.goal, e);
}
...
return L(o.goalWithValue, e, t);
}
function oe(t) {
var n, r, o, i = [ "click", "mouseenter", "touch", "focus", "view" ];
for (t && 0 != t.length || (t = e("body")), n = i.length; n--; ) r = "touch" === i[n] ? "touchstart" :i[n], o = "data-et-" + r, t.find("[" + o + "]").each(function(t, n) {
var i = ie(e(n).attr(o)), a = J(r, n);
i.forEach(function(e) {
a && a[e.action] && a[e.action](e.hash, e.value);
});
});
}
function ie(e) {
...
function ae(e) {
e.url && (n = e.url), e.jset && Z(e.jset), "undefined" != typeof e.useFNV && (y = e.useFNV), "undefined" != typeof e.noJqueryOn && (w = e.noJqueryOn), "undefined" != typeof e.noJqueryAjax && (b = e.noJqueryAjax), "undefined" != typeof e.ajaxHeaders && (E = e.ajaxHeaders), "undefined" != typeof e.snt && (T = e.snt), "function" == typeof e.bindOnView && (N = e.bindOnView), "function" == typeof e.unbindOnView && (x = e.unbindOnView), e.isDevServer && (O = !0);
}
function ue() {
try {
r = t("et_debug");
...
function se() {}
return se.prototype.track = Q, se.prototype.stage = ee, se.prototype.goal = te, se.prototype.customGoal = ne, se.prototype.goalWithValue = re, se.prototype.on = J, se.prototype.set = Z, se.prototype.Trackables = o, se.prototype.configure = ae, se.prototype.initAttributesTracking = oe, new se();
});
...
}), n || (h.month_name_with_year_only = o[parseInt(e[1])].name_with_year_only);
}), a(r[c], h);
...
until:!1,
no_html:!0
}, e), "en-us" == B.env.b_locale && !B.env.ip_country.match(/^(?:us|ca)$/)) return e.time;
...
default:
var c = new Array(f - 1);
for (o = 1; f > o; o++) c[o - 1] = arguments[o];
s.apply(u, c);
}
}
return this;
...
"function" == typeof n && B.require(a || (B.env && B.env.always_pass_require_to_b_when ? [ "require" ] :[]), n.bind(f));
})["catch"](function(e) {
...
}, B.define("cors-detection", function(e, t, n) {
var r;
function o(e) {
if ("undefined" == typeof r) {
r = e ? 1 :0;
var t = new XMLHttpRequest();
t.open("GET", encodeURI("/setcorscapable?capable=" + r)), t.setRequestHeader("X-Booking-CSRF", B.env.b_csrf_token), t.send();
}
}
function i(e) {
var t = document.createElement("script"), n = document.getElementsByTagName("script")[0];
t.src = e, t.crossOrigin = "anonymous", t.type = "text/javascript", t.async = !0, t.onerror = function() {
o(!1), B.env && B.env.b_server_role && B.et.stage("app" === B.env.b_server_role ? "HSCLZfZeVaaXe" :"HSCLWdeJVVXT", 1);
