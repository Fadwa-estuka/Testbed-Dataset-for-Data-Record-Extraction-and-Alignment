var rightside = jQuery("div#hl_1_999").parents(".row-side").parent(".row");
      if(!rightside.hasClass("has-side-banner")){
        rightside.addClass("has-side-banner");
      } ;
...
tmntag.cmd.push(function(){
  tmntag.placement(2337);
  tmntag.target({'kw': removeSpecialCharacters()});
  tmntag.start();
  tmntag.adTag('purch_Y_S_0_1', false);
});

s.linkTrackVars='prop26,eVar50';
  s.prop26='-_--_--_--_--_-DYMX-ADS-16001A_160_Search-_-Pers_MNT_Imp-_--_-'+new Date().toISOString()+'-_-';
  s.eVar50='-_--_--_--_--_-DYMX-ADS-16001A_160_Search-_-Pers_MNT_Imp-_--_-'+new Date().toISOString()+'-_-';
  s.tl(this,'o','Target Banner impression monetate');

if(jQuery){
  jQuery('#purch_Y_S_0_1').click(function(){
    s.linkTrackVars='prop26,eVar50';
  s.prop26='-_--_--_--_--_-DYMX-ADS-16001A_160_Search-_-Pers_MNT-_--_-'+new Date().toISOString()+'-_-';
  s.eVar50='-_--_--_--_--_-DYMX-ADS-16001A_160_Search-_-Pers_MNT-_--_-'+new Date().toISOString()+'-_-';
