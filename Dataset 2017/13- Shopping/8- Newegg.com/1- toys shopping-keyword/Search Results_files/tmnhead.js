...
tmntag_videoAdTag=function(doc, adunit, wind){
	var playerId = '${PAGE_DOMAIN:VIDEOPLAYER_ID}';
...
tmntag_videoSettings=function(doc, adunit, wind){
	var playlistId = '${PAGE_DOMAIN:VIDEOPLAYLIST_ID}';
