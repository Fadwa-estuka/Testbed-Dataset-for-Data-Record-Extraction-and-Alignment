...
tmntag.cmd.push(function(){
  ...
  s.prop26='-_--_--_--_--_-DYMX-ADS-16001A_728_Search-_-Pers_MNT_Imp-_--_-'+new Date().toISOString()+'-_-';
  s.eVar50='-_--_--_--_--_-DYMX-ADS-16001A_728_Search-_-Pers_MNT_Imp-_--_-'+new Date().toISOString()+'-_-';
  s.tl(this,'o','Target Banner impression monetate');

if(jQuery){
  jQuery('#purch_Y_L_0_1').click(function(){
    s.linkTrackVars='prop26,eVar50';
  s.prop26='-_--_--_--_--_-DYMX-ADS-16001A_728_Search-_-Pers_MNT-_--_-'+new Date().toISOString()+'-_-';
  s.eVar50='-_--_--_--_--_-DYMX-ADS-16001A_728_Search-_-Pers_MNT-_--_-'+new Date().toISOString()+'-_-';
