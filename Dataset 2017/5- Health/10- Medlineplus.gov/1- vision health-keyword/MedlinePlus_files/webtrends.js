...
// Created: 8/27/2012 5:18:28 PM

function WebTrends(){
  var that=this;
  // begin: user modifiable
this.dcspl = false;
  this.dcsid="dcsholgz500000kf5i8zqwqax_4f6n";
  this.domain="wtsdc.nlm.nih.gov";
  this.timezone=-5;
  this.fpcdom=".medlineplus.gov";
  this.onsitedoms="";
  this.downloadtypes="exe,dll,com,zip,pdf,arc,bin,sit,tar,gz,z,arj,rpm,rar,doc,mpeg,mp3,avi,mp2,hqx,wav,mp4,txt,xml,tif,mpg,m4v,mov,wmv,f4v,magpie,smil,ogg,m3u8";
...
WebTrends.prototype.dcsIsOnsite=function(host){
  if (host.length>0){
      ...
      if (/searchqa\.nlm\.nih|vsearch\.nlm\.nih/.test(host)) {
        return false;
      }
...
WebTrends.prototype.dcsMultiTrack=function(){
  ...
  if (args.length%2==0){
    ...
    //sid always
    this.DCS.theSID = args[1];
    if ("theORG"==args[2]) {
      this.DCS.theORG = args[3];
      this.DCS.theURL = args[5];
    }
    this.dcsFPC();
    this.dcsTag();
...
WebTrends.prototype.dcsOffsite=function(evt){
  ...
  if (evt&&((typeof(evt.which)!="number")||(evt.which==1))){
    ...
    if (e.href){
      var hn=e.hostname?(e.hostname.split(":")[0]):"";
      var pr=e.protocol||"";
      if (/searchqa\.nlm\.nih|vsearch\.nlm\.nih/.test(hn)) {
        var params = decodeURI(e.href).split("&");
        for (var i=params.length;i--;) {
          try {
            if ("url"==params[i].split("=")[0]) {
              if (!/https:\/\/medlineplus\.gov/.test(unescape(params[i].split("=")[1]))) {
                _url = unescape(params[i].split("=")[1]);
                break;
              }
              else {
                return;
      ...
      if ((hn.length>0)&&(pr.indexOf("http")==0)&&!this.dcsIsOnsite(hn)){
        var qry=e.search?e.search.substring(e.search.indexOf("?")+1,e.search.length):"";
        var pth=e.pathname?((e.pathname.indexOf("/")!=0)?"/"+e.pathname:e.pathname):"/";
        var org = e.getAttribute("data-org");
        sid=e.getAttribute("data-sid");
        _url = (""==_url)?(hn + pth + (qry.length ? ("?" + qry) : "")):_url;
        if (org != undefined) {
          theORG = org;
          theURL = e.href;
        }
        if (""==theORG) {
          this.dcsMultiTrack("theSID",sid,"DCS.dcssip", hn, "DCS.dcsuri", pth, "DCS.dcsqry", this.trimoffsiteparams ? "" : qry, "DCS.dcsref", window.location, "WT.ti", "Offsite:" + _url, "WT.dl", "24", "WT.nv", this.dcsNavigation(evt));
        }
        else {
          this.dcsMultiTrack("theSID",sid,"theORG",theORG,"theURL",theURL,"DCS.dcssip", hn, "DCS.dcsuri", pth, "DCS.dcsqry", this.trimoffsiteparams ? "" : qry, "DCS.dcsref", window.location, "WT.ti", "Offsite:" + _url, "WT.dl", "24", "WT.nv", this.dcsNavigation(evt));
        }
      }
    }
  }
...
WebTrends.prototype.dcsTag=function(){
  ...
  if (/(immunesystem\.html|bonesjointsandmuscles\.html|thyroiddiseases\.html|diabetes\.html|highbloodpressure\.html|videosandcooltools\.html|medlineplus\.html)/.test(window.location.pathname)) {
    this.dcspl = true;
  }
  /*
  if (this.dcspl || -1!=window.location.pathname.indexOf("/tutorials/") || -1==window.location.pathname.indexOf("medlineplus") || -1!=window.location.pathname.indexOf("magazine")) {
    this.dcspl = false;
  ...
  */
  this.dcsCreateImage(P);
  delete this.DCS.theORG;
  delete this.DCS.theURL;
  delete this.DCS.theSID;
  this.WT.ad="";
}
