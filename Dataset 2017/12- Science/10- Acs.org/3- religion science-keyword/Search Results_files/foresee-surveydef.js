...
FSR.properties = {
   ...
   invite: {
      ...
      <div style=\"padding:0 0 8px 0;\">Thank you for visiting www.acs.org. You have been selected to participate<br>in a brief customer satisfaction survey to let us know how we can improve<br>your experience.</div>\
 ...
 exclude: {
  local: [
     ...
     'www.join.acs.org',
     'www.renew.acs.org',
     'presentations.acs.org',
     'portal.acs.org',
     'communities.acs.org',
     'www.store.acs.org',
     'sites.acs.org',
     'worldwide.acs.org',
     'demographics.acs.org',
     'undergrad.acs.org',
     'iyc2011.acs.org',
     'webapplications.acs.org',
     'dgr.rints.com',
     'strategy.acs.org',
     'middleschoolchemistry.com',
     'getexperience.dreamhosters.com',
     'epic.dreamhosters.com',
     'membernumberlookup.acs.org',
     'acswebinars.org',
     'acswebcontent.acs.org/iyckit/',
     'acs.cn.com',
     'giving.acs.org',
     'gcande.org',
     'info.acs.org',
     'my.acs.org',
     'emailpref.acs.org',
      'acs.org/content/acs/en/education/whatischemistry/adventures-in-chemistry/'
    ],
         referrer: []
      },
      include: {
