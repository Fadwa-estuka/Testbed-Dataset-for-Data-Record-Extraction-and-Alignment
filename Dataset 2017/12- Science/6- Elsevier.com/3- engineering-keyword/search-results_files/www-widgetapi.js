...
;var C=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};u("yt.config_",C);function Aa(a){var b=arguments;if(1<b.length){var c=b[0];C[c]=b[1]}else for(c in b=b[0],b)C[c]=b[c]}
...
function La(a,b){var c=m("yt.logging.errors.log");c?c(a,b,void 0,void 0,void 0):(c=[],c="ERRORS"in C?C.ERRORS:c,c.push([a,b,void 0,void 0,void 0]),Aa("ERRORS",c))}
