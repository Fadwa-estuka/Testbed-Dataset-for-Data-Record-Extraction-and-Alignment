...
function s_doPlugins(s) {
	...
	s.prop25= tpA[1];// Set hour
	s.prop29= tpA[2];// Set day
	s.prop30= tpA[3];// Set day type

	//new repeat
	s.prop13=s.getNewRepeat(30,'s_getNewRepeat30');
	s.prop72=s.getNewRepeat(90,'s_getNewRepeat90');

	//monthly visit number
	s.prop74=s.getVisitNum('m','s_vmonthnum','s_monthinvisit');

	//days since last visit
	s.prop75=s.getDaysSinceLastVisit('s_lv');
